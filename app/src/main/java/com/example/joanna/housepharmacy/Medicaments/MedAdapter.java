package com.example.joanna.housepharmacy.Medicaments;
...
public class MedAdapter extends RecyclerView.Adapter<MedAdapter.ViewHolder> {
    ...
    public MedAdapter(ArrayList<Med> meds, RecyclerViewClickListener listener) {
        this.meds = meds;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemLayoutView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.meds_item, null);
