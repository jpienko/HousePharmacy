package com.example.joanna.housepharmacy.DatabaseAdapters;
...
import com.example.joanna.housepharmacy.DatabaseImplementation.DatabaseHelper;
...
public class DatabaseMedAdapter {
    ...
    public Cursor getNames() {
        return db.query(true, DatabaseConstants.MEDSTABLE, new String[]{DatabaseConstants.NAME}, null, null, DatabaseConstants.NAME, null, null, null);
