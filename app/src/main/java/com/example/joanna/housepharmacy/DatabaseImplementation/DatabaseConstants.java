package com.example.joanna.housepharmacy.DatabaseImplementation;
...
public class DatabaseConstants {
    ...
    public static final String CREATE_TABLE_MEDS = "CREATE TABLE " + MEDSTABLE + "("
    ...
    public static final String CREATE_TABLE_PLACES = "CREATE TABLE " + PLACESTABLE + "("
            + ID_PLACE + " INTEGER PRIMARY KEY AUTOINCREMENT, "
            + PLACE_NAME + " TEXT NOT NULL, "
            + PLACE_DESCRIPTION + " TEXT );";

    public static final String CREATE_TABLE_FORMS = "CREATE TABLE " + FORMSTABLE + "("
